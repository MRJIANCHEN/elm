 <template>
    <div>
        <section v-if="!showLoading" class="shop_container">
            ...
            <div class="slide"><i></i><marquee>{{marquee}}</marquee></div>
                    ...
                    <section class="buy_cart_container">
                        <section @click="toggleCartList" class="cart_icon_num">
                            ...
                            <div class="cart_num">
                                ...
                                <div style="font-size:12px" v-show="minimumOrderAmount>totalPrice">{{minimumOrderAmount}}起送,还差¥{{minimumOrderAmount-totalPrice}}</div>
                            </div>
                        </section>
...
　　import 'src/style/swiper.min.css'
    export default {
        data(){
            return{
                geohash: '', //geohash位置信息
                imgArr:['/static/home1.png'],
                marquee:'加入购物车，所需7个参数，商铺id，食品分类id，食品id，食品规格id，食品名字，食品价格，食品规格',//滚动文字
                shopId: null, //商店id值
